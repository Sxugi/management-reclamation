...
namespace App\Http\Requests\RencanaReklamasi;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UpdateRencanaReklamasi extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $rencana_reklamasi = $this->route('rencana_reklamasi');
        ...
        $uniqueTahun = Rule::unique('data_reklamasi')
            ...
            ->ignore($rencana_reklamasi->data_reklamasi_id, 'data_reklamasi_id');
        ...
        return [
            ...
            'timbuman_limbah_fasilitas' => 'numeric',
