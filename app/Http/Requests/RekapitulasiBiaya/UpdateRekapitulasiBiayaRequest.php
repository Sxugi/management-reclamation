...
class UpdateRekapitulasiBiayaRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $rekapitulasi_biaya = $this->route('rekapitulasi_biaya');
        ...
        $uniqueTahun = Rule::unique('biaya_reklamasi')
            ...
            ->ignore($rekapitulasi_biaya->biaya_reklamasi_id, 'biaya_reklamasi_id');
