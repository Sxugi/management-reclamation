<x-main-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg sm:rounded-lg font-outfit">
        <div class="p-6">
            <div class="self-stretch flex flex-row items-center justify-start gap-1 mb-6">
                ...
                <a href=" {{ route('lahan.dokumentasi.index', [$lahan]) }} " class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200 font-outfit">
