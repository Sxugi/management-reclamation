    ...
    <x-slot name="header">
        <div class="flex flex-row items-center justify-between gap-4">
            ...
            <div class="self-stretch flex flex-row items-center justify-start gap-1.5 text-left text-sm text-slategray font-outfit">
                ...
                <div class="relative leading-5 text-darkslategray-200 font-medium">Menambahkan Data Anggaran Reklamasi</div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-6">
        <div class="self-stretch mx-auto">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg sm:rounded-lg">
                <div class="p-6">
                    <x-anggaran-reklamasi.form-fields :lahan="$lahan" :kategoriAnggaranList="$kategoriAnggaranList" />
                </div>
            </div>
        </div>
    </div>
