<div x-data="{ 
    ...
    class="h-full w-64 z-50 fixed overflow-y-auto overflow-x-hidden bg-gainsboro border-darkslategray border-solid border-b-[0px] border-r-[1px] border-l-[0px] border-t-[0px] box-border flex flex-col items-start justify-start pt-8 px-5 pb-5 gap-7 text-left text-sm text-white font-outfit">
    ...
    <div class="self-stretch flex flex-col items-start justify-start gap-2.5">
        <div class="self-stretch flex flex-col items-start justify-start gap-4">
            ...
            <div class="self-stretch flex flex-col items-start justify-start gap-1 text-sm">
                ...
                <!-- Anggaran -->
                <a href="{{ route('lahan.anggaran.index', ['lahan' => $globalLahanId]) }}"
                   class="self-stretch rounded-lg flex flex-row items-center justify-start py-2 px-3 no-underline hover:bg-white hover:text-darkslategray ease-in-out
                   {{ request()->routeIs('expense.*', 'lahan.anggaran.*') ? 'bg-white !text-darkslategray' : 'bg-darkslategray text-white' }}">
                    <div class="flex-1 flex flex-row items-center justify-start gap-3">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Data Pohon -->
                <a href="{{ route('lahan.pohon.index', ['lahan' => $globalLahanId]) }}" 
                   class="self-stretch rounded-lg flex flex-row items-center justify-start py-2 px-3 no-underline hover:bg-white hover:text-darkslategray ease-in-out
                   {{ request()->routeIs('expense.*', 'lahan.pohon.*') ? 'bg-white !text-darkslategray' : 'bg-darkslategray text-white' }}">
                    <div class="flex-1 flex flex-row items-center justify-start gap-3">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
