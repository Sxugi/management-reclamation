...
<div class="flex flex-row items-center justify-center gap-3 p-4 mt-auto">
    <button type="button"
        ...
        class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-2.5 px-4 gap-2 !text-white border-none cursor-pointer hover:bg-slategray-200">
        <span class="text-leading-5 font-medium text-sm">Lihat Detail</span>
    </button>
    
    <div class="relative" x-data="{ open: false }">
        <button @click="open = !open" 
                class="flex border-none fill-none bg-darkslategray hover:bg-slategray-200 rounded-lg p-2.5 items-center"
                title="More Options">
        ...
        <div x-show="open" 
            ...
            <div class="py-1">
                ...
                <button x-data="" 
                        ...
                        class="w-full px-4.5 py-2 text-sm rounded-md text-white hover:bg-slategray-200 flex items-center gap-2 no-underline font-outfit border-none bg-transparent">
