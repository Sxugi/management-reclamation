<div class="flex flex-row items-center justify-center gap-3 p-4 mt-auto">
    <a href="{{ route('lahan.dokumentasi.show',  [$lahan, $doc]) }}" 
        class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-2.5 px-4 gap-2 !text-white no-underline hover:bg-slategray-200">
