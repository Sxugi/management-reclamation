...
@php
    ...
    $lahanYangDibukaFields = [
        ...
        'Area Diluar Penambangan' => [
            ...
            'Timbunan/Penyimpanan Limbah Fasilitas Penunjang' => ['kegiatan' => 'timbunan_limbah_fasilitas', 'kategori' => 'lahan_dibuka', 'satuan' => 'ha'],
    ...
    $pemanfaatanLubangFields = [
        'Stabilisasi Lereng (ha)' => ['kegiatan' => 'stabilisasi_lereng', 'kategori' => 'pemanfaatan_lubang', 'satuan' => 'ha'],
        'Pengamanan Lubang Bekas Tambang (void) (ha)' => ['kegiatan' => 'pengamanan_lubang', 'kategori' => 'pemanfaatan_lubang', 'satuan' => 'ha'],
        'Pemulihan dan Pemantauan Kualitas Air dan Serta Pengolahan Air dalam Lubang Bekas Tambang (void) Sesuai dengan Peruntukannya' => ['kegiatan' => 'pemulihan_kualitas_air', 'kategori' => 'pemanfaatan_lubang', 'satuan' => 'unit'],
        'Pemeliharaan Lubang Bekas Tambang (void)' => ['kegiatan' => 'pemeliharaan_lubang', 'kategori' => 'pemanfaatan_lubang', 'satuan' => 'unit'],
    ];
...
>
    ...
    <input type="hidden" name="tipe" value="rekapitulasi">
    ...
    <div class="flex flex-col items-start justify-start gap-6">
        ...
        <div class="self-stretch rounded-2xl bg-white border-gainsboro border-solid border-[1px] flex flex-col items-center justify-start">
            <div class="self-stretch rounded-t-2xl border-gainsboro border-solid border-b-[1px] border-t-[0px] border-l-[0px] border-r-[0px] flex flex-row items-start justify-start py-5 px-6">
                <div class="flex flex-col items-start justify-start">
                    <b class="relative leading-6">Pemanfaatan Lubang Bekastambang (void)</b>
                </div>
            </div>
            <div class="self-stretch flex flex-col items-start justify-start p-6 gap-6 text-sm text-darkslategray-200">
