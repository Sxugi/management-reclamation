    ...
    @if (request()->routeIs('lahan.rekapitulasi-reklamasi.index'))
        <div class="rounded-lg bg-darkslategray-300 overflow-hidden flex flex-row items-center justify-center gap-2">
            @if ($rekapitulasi_reklamasi)
                <a href="{{ route('lahan.rekapitulasi-reklamasi.edit', [$lahan->lahan_id, $rekapitulasi_reklamasi->data_reklamasi_id]) }}" class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200">
            ...
            @else
                <a href="{{ route('lahan.rekapitulasi-reklamasi.create', $lahan->lahan_id) }}?tahun={{ $tahun_aktif }}" class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200">
