...
<div class="relative inline-block gap-2">
    <div class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200"
        data-filter-panel-toggle
        onclick="window.toggleGudangFilterPanel()">
    ...
    <div id="gudangFilterPanel" class="absolute right-0 z-50 mt-2 p-4 bg-white border border-gray-300 rounded-lg shadow-lg hidden">
        <form id="gudangFilterForm" method="GET" action="{{ route('lahan.gudang.index', $lahan->lahan_id) }}" class="space-y-3">
            ...
            <div class="flex justify-between pt-2">
                <x-main.primary-button type="button" onclick="window.clearGudangFilters()" class="px-4 py-2">Clear</x-main.primary-button>
                <div class="flex gap-2">
                    <x-main.primary-button type="button" onclick="window.closeGudangFilterPanel()" class="px-4 py-2">Cancel</x-main.primary-button>
