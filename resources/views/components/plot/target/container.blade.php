<div class="mb-6 bg-white rounded-2xl overflow-hidden shadow-md flex flex-col">
    ...
    <div class="px-6 py-4 border-[0px] border-b-[1px] border-gainsboro border-solid flex justify-between items-center">
        ...
        @if($list->isNotEmpty())
            <a
                type="button"
                class="cursor-pointer rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200"
