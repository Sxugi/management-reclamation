        ...
        <div class="self-stretch flex flex-col items-start justify-start p-6">
            <div class="self-stretch flex flex-col gap-4">
                <div class="flex flex-col gap-2">
                    ...
                    <x-main.text-input type="text" name="nama_plot" x-model="nama_plot" class="w-full text-darkslategray rounded-lg border-lightgray border-solid border-[1px] p-2.5" />
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <x-main.text-input type="text" name="luas_area" x-model="luas_area" class="w-full text-darkslategray rounded-lg border-lightgray border-solid border-[1px] p-2.5" />
