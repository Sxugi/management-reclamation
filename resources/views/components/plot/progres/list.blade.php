    ...
    <div class="px-6 py-4 flex justify-between items-center">
        ...
        <div class="flex gap-3">
            ...
            <div class="rounded-lg bg-darkslategray-300 overflow-hidden flex flex-row items-center justify-center gap-2">
                <a href="{{ route('plot.progres.create', $plot->plot_id) }}" class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200">
