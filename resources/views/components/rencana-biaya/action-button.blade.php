...
<div class="flex flex-row items-center justify-between gap-2 py-4 text-white">
    @if (request()->routeIs('lahan.rencana-biaya.index'))
        <div class="rounded-lg bg-darkslategray-300 overflow-hidden flex flex-row items-center justify-center gap-2">
            @if ($rencana_biaya)
                <a href="{{ route('lahan.rencana-biaya.edit', [$lahan->lahan_id, $rencana_biaya->biaya_reklamasi_id]) }}?currency={{ $currency }}" class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200">
            ...
            @else
                <a href="{{ route('lahan.rencana-biaya.create', $lahan->lahan_id) }}?tahun={{ $tahun_aktif }}&currency={{ $currency }}" class="rounded-lg bg-darkslategray overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-2 !text-white no-underline hover:bg-slategray-200">
