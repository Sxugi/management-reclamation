<section class="space-y-6">
    ...
    >{{ __('Delete Account') }}</x-main.danger-button>

    <x-main.modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                <x-main.input-label for="password" value="{{ __('Password') }}" class="sr-only" />
