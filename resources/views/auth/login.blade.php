<x-guest-layout>
    <div class="w-full relative bg-whitesmoke-100 overflow-hidden flex flex-col items-center justify-center py-10 md:py-20 lg:py-[180px] px-4 md:px-12 lg:px-24 xl:px-[120px] box-border text-left text-4xl text-whitesmoke font-outfit">
        <div class="rounded-[25px] bg-darkslategray w-full max-w-lg h-auto flex flex-col items-center justify-center py-8 md:py-12 lg:py-[54px] px-4 md:px-8 lg:px-[86px] box-border">
            <div class="w-full flex flex-col items-center justify-center gap-6 md:gap-8">
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('login') }}" class="self-stretch flex flex-col items-center justify-center text-sm text-gray-100">
                    @csrf
                    ...
                    <div class="w-full flex flex-row flex-wrap items-center justify-between gap-2 text-slategray-100 mt-4 font-outfit">
                        <div class="flex flex-row items-center justify-start gap-3">
                            <input id="remember_me" type="checkbox" name="remember" class="rounded border-lightgray border-solid border-[1.3px] w-5 h-5 shrink-0">
